...
public class JmJobDetail implements java.io.Serializable {
	...
	public String toString() {
		return "JmJobDetail [id=" + id + ", job_name=" + job_name + ", job_group=" + job_group + ", description="
				...
				+ ", cron_expression=" + cron_expression + ", starttime=" + starttime + ", endtime=" + endtime
				+ ", isexecuting=" + isexecuting + ", instance_status=" + instance_status + ", exception_info="
				+ exception_info + ", qrtzcount=" + qrtzcount + ", orderNum=" + orderNum + "]";
	}
