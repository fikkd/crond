													...
													<tbody>
														<tr>
															...
															<td>
																...
																<label class="radio-lab" for="zlpl_2"><input type="radio" name="zlpl" id="zlpl_2" value="2" />每周</label> 
																<label class="radio-lab" for="zlpl_3"><input type="radio" name="zlpl" id="zlpl_3" value="3" />每月</label> 
																		...
																		<tbody>
																			<tr>
																				...
																				<td>
																					...
																					<input type="checkbox" name="week" id="week_7" value="7" title="星期六" /><span>星期六</span></td>
																			</tr>
																	</table>
																</div>
																	...
																	<table class="detailtable" cellpadding="0" cellspacing="0" style="width: 100%;">
																		...
																		<tbody>
																			<tr>
																				...
																				<td>
																					<div class="txt-mid numbox" id="monthday"></div>天
																					<input type="radio" name="monthpl" value="week" />在:
																	...
																	<table class="detailtable" cellpadding="0" cellspacing="0" style="width: 100%;">
																		...
																		<tbody>
																			<tr>
																				<th>第:</th>
																				<td>
																					<div class="txt-mid numbox" id="monthSel"></div>月
												...
												<table class="detailtable" cellpadding="0" cellspacing="0" style="width: 100%;">
													...
													<tbody>
														...
														<tr data-daypl="com">
															...
															<td>
																<div class="txt-mid numbox" id="zxjg"></div> 
												...
												<table class="detailtable" cellpadding="0" cellspacing="0" style="width: 100%;">
													...
													<tbody>
														<tr>
															<th>开始时间:</th>
															<td>
																<input name="starttime" value="${starttime}" class="txt-mid txt-date" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
															</td>
														</tr>
														<tr>
															<th><input type="radio" name="hasEnd" value="yes" />结束时间:</th>
															<td><input name="endtime" value="${endtime}" class="txt-mid txt-date" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
														</td>
														</tr>
														<tr>
															<th><input type="radio" name="hasEnd" value="no" />无结束时间:</th>
															<td></td>
														</tr>
												</table>
											</div>
