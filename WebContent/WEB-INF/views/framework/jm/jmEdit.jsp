...
<head lang="en">
	...
	<script type="text/javascript">
		...
		var id = '${jobDetail.id}', starttime = '${jobDetail.starttime}', endtime = '${jobDetail.endtime}', 
		isjobclass = '${jobDetail.isjobclass}' || 0, trigger_type = '${jobDetail.trigger_type}' || 0, instance_status = '${jobDetail.instance_status}' || 0, 
		isexecuting = '${jobDetail.isexecuting}' || 0, time_limitv = '${jobDetail.time_limit}' || 1, //倒计时
